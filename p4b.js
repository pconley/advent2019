...
console.log(is_valid(112233))
assert( is_valid(112233) == 0 )
console.log(is_valid(123444))
assert( is_valid(123444) == 1 )
console.log(is_valid(111122))
assert( is_valid(111122) == 0 )
